...
function ShowPost(props) {
  ...
  return (
    <Container>
    <Card style={{marginBottom:'30px',marginTop:'20px',padding:'20px',border:'2px solid red'}}>
      ...
      <Link to={`/posts/${id}`}>
        <Button variant="contained" color="primary" style={{marginTop:'10px',marginBottom:'0px'}}>
          See more
        </Button>
      </Link>
